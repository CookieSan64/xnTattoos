...
Config.Shops = {
	vec(1321.8685, -1654.5448, 52.2771), -- East Los Santos
	vec(-1154.9479, -1427.9492, 4.9560), -- Plage
	vec(-3170.1423, 1078.3687, 20.8307), -- Route 1
	vec(324.7953, 180.9866, 103.5881), -- Vinewood
	vec(-295.1490, 6200.6050, 31.4883), -- Paleto

	--vec(1864.893, 3747.519, 32.0294), -- Sandy Shores
	--vec(-586.5123, -599.8925, 40.43034), -- Centre Commercial
}
